...
public class AccessoryService {
    ...
    //* Reto 5 metodos
    public List<Accessory> getProductByPrice(String price){
        double priceValue = Double.parseDouble(price);
        return accesoryRepository.getProductbyPrice(priceValue);
    }
    public List<Accessory> getProductByDescription(String description){
        return accesoryRepository.getProductByDescription(description);
    }
}
